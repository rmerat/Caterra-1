...
def LoadGroundTruth(name_images, imagePerso, imageHeight = 240, imageWidth = 320, nb_crop = 4):
    ...
    for v in range(v0, imageHeight):
        ...
        cv2.circle(imagePerso, (int(dist_x), v), 1, (0,255,0), 1)

        while(dist_x>0):
            dist_x = dist_x - spacing
            pt = (int(dist_x), v)
            cv2.circle(GTImage, pt, 1, (255,0,0), 1)
            cv2.circle(imagePerso, pt, 1, (0,255,0), 1)
